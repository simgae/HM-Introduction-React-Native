...
export default function RecipeProvider({
  ...
  // But by doing it this way, we create only read access to the data behind the context.
  // @see: https://react.dev/reference/react/useContext#passing-data-deeply-into-the-tree
  // Yes, we can call `setRecipe` from the context, but the change will not be reflected in the provider.
